//LIBRERIA DE ESCRITURA V1-CONFIRMADA 25/01/2022
...
uint8_t fx=Modbus_Write;
uint16_t Registro=122;
uint16_t reg=(Registro*10)-1;
uint16_t msg=213;//voltaje
...
void Modbus_transmision(uint8_t address_,uint16_t reg_,uint16_t msg_)
{
  ...
  */  
  ...
  delay(500);
  //delay(3000);//CONSIDERAR BORRAR-borrado 24/01/2022
  digitalWrite(TX,1);//escritura

  //**ARMADO DE TRAMA MOBDUS***
  Serial1.write(address_);//ADDRESS ID SLAVE
  Serial1.write(fx);//funcion escritura
